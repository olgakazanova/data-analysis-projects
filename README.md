...
- Analyzed customer data to identify key churn drivers  
...
- Analyzed database structure using SQL  
- Evaluated activity of authors, publishers, and users  
- Identified popular and highly rated books  
- Detected active users and engagement patterns  
